...
infile = '1996ndpinvaryingbaadconcentrations.072324.txt'; 
...
r1996in001fm = GRf(2:4,2);
OD1996in001fm = shiftdim(OD6(2:4,2,:),2)-0.084;
OD1996in001fmm = mean(OD1996in001fm,2);
figure
plot(trng,OD1996in001fm)
hold on
plot(trng,OD1996in001fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in001fm')

CC_1996in001fm = max(OD1996in001fm,[],1);
...
r1996in002fm = GRf(2:4,3);
trng = dt*(1:N);
OD1996in002fm = shiftdim(OD6(2:4,3,:),2)-0.084;
OD1996in002fmm = mean(OD1996in002fm,2);
figure
plot(trng,OD1996in002fm)
hold on
plot(trng,OD1996in002fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in002fm')

CC_1996in002fm = max(OD1996in002fm,[],1);

disp('1996in002fm')
disp(r1996in002fm')
disp(CC_1996in002fm)

r1996in005fm = GRf(2:4,4);
trng = dt*(1:N);
OD1996in005fm = shiftdim(OD6(2:4,4,:),2)-0.084;
OD1996in005fmm = mean(OD1996in005fm,2);
figure
plot(trng,OD1996in005fm)
hold on
plot(trng,OD1996in005fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in005fm')

CC_1996in005fm = max(OD1996in005fm,[],1);

disp('1996in005fm')
disp(r1996in005fm')
disp(CC_1996in005fm)

r1996in01fm = GRf(2:4,5);
trng = dt*(1:N);
OD1996in01fm = shiftdim(OD6(2:4,5,:),2)-0.084;
OD1996in01fmm = mean(OD1996in01fm,2);
figure
plot(trng,OD1996in01fm)
hold on
plot(trng,OD1996in01fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in01fm')

CC_1996in01fm = max(OD1996in01fm,[],1);

disp('1996in01fm')
disp(r1996in01fm')
disp(CC_1996in01fm)

r1996in02fm = GRf(2:4,6);
trng = dt*(1:N);
OD1996in02fm = shiftdim(OD6(2:4,6,:),2)-0.084;
OD1996in02fmm = mean(OD1996in02fm,2);
figure
plot(trng,OD1996in02fm)
hold on
plot(trng,OD1996in02fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in02fm')

CC_1996in02fm = max(OD1996in02fm,[],1);

disp('1996in02fm')
disp(r1996in02fm')
disp(CC_1996in02fm)

r1996in05fm = GRf(2:4,7);
trng = dt*(1:N);
OD1996in05fm = shiftdim(OD6(2:4,7,:),2)-0.084;
OD1996in05fmm = mean(OD1996in05fm,2);
figure
plot(trng,OD1996in05fm)
hold on
plot(trng,OD1996in05fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in05fm')

CC_1996in05fm = max(OD1996in05fm,[],1);

disp('1996in05fm')
disp(r1996in05fm')
disp(CC_1996in05fm)

r1996in1fm = GRf(2:4,8);
trng = dt*(1:N);
OD1996in1fm = shiftdim(OD6(2:4,8,:),2)-0.084;
OD1996in1fmm = mean(OD1996in1fm,2);
figure
plot(trng,OD1996in1fm)
hold on
plot(trng,OD1996in1fmm,'k:')
set(gca,'YScale','log')
xlabel('Time (hours)')
ylabel('OD')
title('1996in1fm')

CC_1996in1fm = max(OD1996in1fm,[],1);
...
CC_1996infm = [CC_1996in001fm',CC_1996in002fm',CC_1996in005fm', CC_1996in01fm', CC_1996in02fm',CC_1996in05fm', CC_1996in1fm'];
r1996infm = [r1996in001fm,r1996in002fm,r1996in005fm, r1996in01fm, r1996in02fm,r1996in05fm, r1996in1fm];

figure
plot(r1996infm,CC_1996infm,'o')
axis([0, 0.6, 0, 0.35])
xlabel('growth rate')
ylabel('carrying capacity')
legend('0.01x','0.02x','0.05x','0.1x','0.2x','0.5x','1x')

% r1996inglu002fm = r(2:4,9);
% trng = dt*(1:N);
% OD1996inglu002fm = shiftdim(OD6(2:4,9,:),2)-0.084;
% OD1996inglu002fmm = mean(OD1996inglu002fm,2);
% figure
% plot(trng,OD1996inglu002fm)
% hold on
% plot(trng,OD1996inglu002fmm,'k:')
% set(gca,'YScale','log')
% xlabel('Time (hours)')
% ylabel('OD')
% title('1996inglu002fm')
% 
% CC_1996inglu002fm = max(OD1996inglu002fm,[],1);
% 
% disp('1996inglu002fm')
% disp(r1996inglu002fm')
% disp(CC_1996inglu002fm)
% 
% r1996inglu01fm = r(2:4,10);
% trng = dt*(1:N);
% OD1996inglu01fm = shiftdim(OD6(2:4,10,:),2)-0.084;
% OD1996inglu01fmm = mean(OD1996inglu01fm,2);
% figure
% plot(trng,OD1996inglu01fm)
% hold on
% plot(trng,OD1996inglu01fmm,'k:')
% set(gca,'YScale','log')
% xlabel('Time (hours)')
% ylabel('OD')
% title('1996inglu01fm')
% 
% CC_1996inglu01fm = max(OD1996inglu01fm,[],1);
% 
% disp('1996inglu01fm')
% disp(r1996inglu01fm')
% disp(CC_1996inglu01fm)
% 
% r1996inglu02fm = r(2:4,11);
% trng = dt*(1:N);
% OD1996inglu02fm = shiftdim(OD6(2:4,11,:),2)-0.084;
% OD1996inglu02fmm = mean(OD1996inglu02fm,2);
% figure
% plot(trng,OD1996inglu02fm)
% hold on
% plot(trng,OD1996inglu02fmm,'k:')
% set(gca,'YScale','log')
% xlabel('Time (hours)')
% ylabel('OD')
% title('1996inglu02fm')
% 
% CC_1996inglu02fm = max(OD1996inglu02fm,[],1);
% 
% disp('1996inglu02fm')
% disp(r1996inglu02fm')
% disp(CC_1996inglu02fm)



rdpin001fm = GRf(5:7,2);
trng = dt*(1:N);
ODdpin001fm = shiftdim(OD6(5:7,2,:),2)-0.084;
...
trng = dt*(1:N);
ODdpin002fm = shiftdim(OD6(5:7,3,:),2)-0.084;
...
trng = dt*(1:N);
ODdpin005fm = shiftdim(OD6(5:7,4,:),2)-0.084;
...
rdpin01fm = GRf(5:7,5);
trng = dt*(1:N);
ODdpin01fm = shiftdim(OD6(5:7,5,:),2)-0.084;
...
rdpin02fm = GRf(5:7,6);
trng = dt*(1:N);
ODdpin02fm = shiftdim(OD6(5:7,6,:),2)-0.084;
...
rdpin05fm = GRf(5:7,7);
trng = dt*(1:N);
ODdpin05fm = shiftdim(OD6(5:7,7,:),2)-0.084;
...
rdpin1fm = GRf(5:7,8);
trng = dt*(1:N);
ODdpin1fm = shiftdim(OD6(5:7,8,:),2)-0.084;
...
% trng = dt*(1:N);
% ODdpinglu002fm = shiftdim(OD6(5:7,9,:),2)-0.084;
...
% trng = dt*(1:N);
% ODdpinglu01fm = shiftdim(OD6(5:7,10,:),2)-0.084;
...
% trng = dt*(1:N);
% ODdpinglu02fm = shiftdim(OD6(5:7,11,:),2)-0.084;
